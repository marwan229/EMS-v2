...
import { Fuel, RefreshCw, Expand } from 'lucide-react';
import { PieChart, Pie, Cell, ResponsiveContainer } from 'recharts';
import { Card, CardAction } from '../Card';

const gaugeData = [{ value: 19.8 }, { value: 20 - 19.8 }];
const COLORS = ['#1abc9c', '#ecf0f1'];

export const FuelCellCard: React.FC = () => {
    return (
        <Card title="Fuel Cell" icon={<Fuel />} actions={
            <>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4 text-center border-t pt-4">
                <div>
                    ...
                    <p className="text-xl font-bold text-gray-800">55.3%</p>
                </div>
                <div>
                    <p className="text-sm text-gray-500">H2 Flow</p>
                    <p className="text-xl font-bold text-gray-800">12.4 L/min</p>
                </div>
                <div>
                    <p className="text-sm text-gray-500">Daily Yield</p>
                    <p className="text-xl font-bold text-gray-800">250.6 kWh</p>
                </div>
                <div>
