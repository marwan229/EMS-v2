...
import { Sun, RefreshCw, Expand } from 'lucide-react';
import { PieChart, Pie, Cell, ResponsiveContainer } from 'recharts';
import { Card, CardAction } from '../Card';

const gaugeData = [{ value: 18.2 }, { value: 20 - 18.2 }];
const COLORS = ['#f1c40f', '#ecf0f1'];

export const PVSystemCard: React.FC = () => {
    return (
        <Card title="PV System" icon={<Sun />} actions={
            <>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4 text-center border-t pt-4">
                ...
                <div>
                    <p className="text-sm text-gray-500">Peak Today</p>
                    <p className="text-xl font-bold text-gray-800">19.1 kW</p>
                </div>
                <div>
                    <p className="text-sm text-gray-500">Daily Yield</p>
                    <p className="text-xl font-bold text-gray-800">85.3 kWh</p>
                </div>
                <div>
